...
<body>
	<div class="container">
		...
		<div class="login-container">
			<form class="hellogb" action="index.html">
				<img class="chips" src="images/logo2.png">
				...
				<div class="input-div one">
					...
					<div>
						<h5>ID</h5>
						<input class="input" type="text"><!-- 이 인풋태그는 그대로 쓰면 그냥 선으로 네모박스가 나온다. css로 보통 그 모든 걸 없애고 커서만 둥둥 밑줄위에 떠있게 만드는 편이다. 연결된 클래스명을 찾아 보면 어떻게 없애는지 볼 수 있다 -->
					</div>
				</div>
